...
def write_initial(config):
    ...
    def flood_3d_source(source, label):
        ...
        # value upward, then let Kara fill horizontal gaps independently at
        # each target depth.  Deep values are extended downward only after
        # horizontal remapping to the MOM6 grid.
        reverted = (
